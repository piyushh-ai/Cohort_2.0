...
const App = () => {
  ...
  const fetcheAllNotes = () => {
    axios.get("https://notesapp-df9o.onrender.com/api/notes").then((hihi) => {
  ...
  const handlesubmit = (e) => {
    ...
    axios
      .post("https://notesapp-df9o.onrender.com/api/notes", {
        title: title.value,
  ...
  const deleteHandler = (id) => {
    axios.delete("https://notesapp-df9o.onrender.com/api/notes/" + id).then((res) => {
      console.log(res);
      fetcheAllNotes();
    });
  };
