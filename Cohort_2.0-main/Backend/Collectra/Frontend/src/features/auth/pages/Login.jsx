...
// ─── Left Panel — shown only on desktop ──────────────────
const AuthLeftPanel = () => (
  <div className="auth-left-panel">
    ...
    <div className="auth-panel-center">
      <h2 className="auth-panel-headline">
        Your knowledge,<br />
        <span className="gradient-word">finally alive.</span>
      </h2>
      <p className="auth-panel-subtext">
        Save anything from the web. Organize, highlight, and rediscover
        the content that makes you smarter.
      </p>
        ...
        {[
          {
            ...
            sub: "Articles, videos, PDFs, tweets",
          },
          {
            icon: "✦",
            bg: "rgba(167,139,250,0.12)",
            title: "AI highlights",
            sub: "Extract key insights instantly",
          },
          {
            icon: "◎",
            bg: "rgba(52,211,153,0.12)",
            title: "Smart collections",
            sub: "Organized, searchable, beautiful",
          },
        ].map((f) => (
    ...
    <div className="auth-panel-footer">
      <p className="auth-panel-quote">
        "Stop losing great content.<br />
        Start building a vault worth keeping."
      </p>
    </div>
  </div>
);
      ...
      <div className="auth-right-panel">
        <div className="auth-card">
          ...
          <div className="auth-form-title">
            <h2>Welcome back</h2>
            <p>Sign in to your vault and pick up where you left off.</p>
          </div>
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="auth-btn" disabled={loading}>
              {loading ? <span className="spinner" /> : "Sign in to Collectra"}
            </button>
          </form>
          ...
          <p className="auth-switch">
            No vault yet? <Link to="/register">Create one free →</Link>
          </p>
        </div>
      </div>
    </div>
