...
const ItemCard = ({ item }) => {
  ...
  // Type badge colors — matched to welcome screen accent palette
  const typeColors = {
    article:  { bg: "rgba(56,189,248,0.1)",   color: "#38bdf8" },
    video:    { bg: "rgba(251,113,133,0.1)",   color: "#fb7185" },
    pdf:      { bg: "rgba(251,191,36,0.1)",    color: "#fbbf24" },
    image:    { bg: "rgba(52,211,153,0.1)",    color: "#34d399" },
    tweet:    { bg: "rgba(29,155,240,0.1)",    color: "#1d9bf0" },
    document: { bg: "rgba(167,139,250,0.1)",   color: "#a78bfa" },
  };
      ...
      <div className="item-card-image">
        {item.image ? (
          ...
          <div className="item-card-image-placeholder">
            <span style={{ color: typeStyle.color, fontSize: "12px", fontWeight: 600, fontFamily: "var(--font-mono)", letterSpacing: "0.06em" }}>
          ...
          <div style={{ position: "relative" }} ref={menuRef}>
            ...
            {menuOpen && showCollectionPicker && (
              <div className="card-dropdown collection-picker">
                <div className="collection-picker-header" onClick={(e) => e.stopPropagation()}>
                  <button
                ...
                {collections.length === 0 ? (
                  <p className="collection-picker-empty">No collections yet</p>
                ) : (
                  collections.map((col) => (
                    <button
                      key={col._id}
                    ...
                    >
                      ...
                      {item.collectionId === col._id && (
                        <svg width="11" height="11" viewBox="0 0 16 16" fill="currentColor" style={{ marginLeft: "auto", color: "var(--cyan)" }}>
